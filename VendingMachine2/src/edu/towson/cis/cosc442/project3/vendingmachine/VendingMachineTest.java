 ...
 *
 * @generatedBy CodePro at 3/16/16 3:08 PM
 * @author Jorden
...
public class VendingMachineTest {
	...
	public void testMakePurchase_1()
		throws Exception {
		VendingMachine fixture = new VendingMachine();
		fixture.setBalance(Double.MAX_VALUE);
		String code = "A";
	...
	/**
	 * Run the void setBalance(double) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/16/16 3:08 PM
